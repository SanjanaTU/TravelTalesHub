    ...
    <div className="main">
      ...
      <div className="signup">
        <form>
          ...
          <input className='input' style={{width:'60%'}}  type="text" name="txt" placeholder='User name' required=""  />
          <input className='input' type="email" name="email" placeholder='Email' required=""  />
          <input className='input'  type="Password" name="pswd" placeholder='Password' required=""  />
          <Link to={`/HomePage`} >
          <button style={{ cursor:'pointer'       }}className='button'  Link to={'/HomePage'}>Sign up</button>
           </Link>
        </form>
      </div>
      <div className="login">
        <form>
          ...
          <input className='input'  type="Password" name="pswd" placeholder='Password' required=""  />
          <Link to={`/HomePage`}>
          <button style={{ cursor:'pointer'}}className='button'  Link to={'/HomePage'}>Log in</button>
           </Link>
